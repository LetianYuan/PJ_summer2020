...
<head>
    ...
    <script defer src="js/decodeHTMLElement.js"></script>
    <script defer src="js/getQueryVariable.js"></script>
    <script defer src="js/upload_showUploadStatus.js"></script>
</head>
<body>
<nav:nav para="NONE"/>
<%
    ...
    {
        pic = (Picture) request.getAttribute("picture");
%>
<script>//jsp向js传参
let title = '<%=pic.getTitle()%>';
let content = '<%=pic.getContent()%>';
let cityName = '<%=pic.getCity()%>';
let countryName = '<%=pic.getCountry()%>';
let path = 'img/travel_images/large/<%=pic.getPath()%>';
let description = '<%=pic.getDescription().replaceAll("'","\\\\'").replaceAll("\\s"," ")%>';
</script>
<script defer src="js/upload_modify.js"></script>
<%
    }
%>
<main>
            ...
            <li class="content">
                <form action='upload' method='post' enctype='multipart/form-data' id="upload">
                    <div id="pic_area">
                        ...
                        <br/>
                        <span id="pic_status">图片未上传</span>
                        <br/>
                        <input type="file" name="picture" id="pic_fileBtn"
                               accept="image/gif,image/jpeg,image/jpg,image/png"/>
                        <script src="js/upload_upload_picture.js"></script>
                    </div>
                    <label for="pic_title">图片标题：</label>
                    <input type="text" name="title" id="pic_title" placeholder="请输入您为图片取的名字" required>
                    <br/>
                    <label for="content">主&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题：</label>
                    <input type="text" name="content" id="content" placeholder="请输入图片主题" required>
                    <br/>
                    ...
                    <br/>
                    <label for="pic_description">图片描述：</label>
                    <textarea id="pic_description" name="description" placeholder="在此输入您的图片描述" required></textarea>
                    <br/>
